...
for (iii in 1:length(filelist)) {
  ...
  ag.data$xy <- ag.data$V1 * ag.data$V2
  ag.data$yz <- ag.data$V2 * ag.data$V3
  ag.data$xz <- ag.data$V1 * ag.data$V3
  ag.data$xyz <- ag.data$V2 * ag.data$V2 * ag.data$V3
  ag.data.sum <- data.frame(mean.vm=tapply(ag.data$vm,ag.data$min,mean,na.rm=T),
                            ...
                            min.x = tapply(ag.data$V1, ag.data$min, min),
                            min.y = tapply(ag.data$V2, ag.data$min, min),
                            min.z = tapply(ag.data$V3, ag.data$min, min),
                            max.x = tapply(ag.data$V1, ag.data$min, max),
                            max.y = tapply(ag.data$V2, ag.data$min, max),
                            max.z = tapply(ag.data$V3, ag.data$min, max),
                            mean.x = tapply(ag.data$V1, ag.data$min, mean, na.rm=T),
                            mean.y = tapply(ag.data$V2, ag.data$min, mean, na.rm=T),
                            mean.z = tapply(ag.data$V3, ag.data$min, mean, na.rm=T),
                            sd.x = tapply(ag.data$V1, ag.data$min, sd, na.rm=T),
                            sd.y = tapply(ag.data$V2, ag.data$min, sd, na.rm=T),
                            sd.z = tapply(ag.data$V3, ag.data$min, sd, na.rm=T),
                            mean.xy = tapply(ag.data$xy, ag.data$min, mean, na.rm=T),
                            mean.yz = tapply(ag.data$yz, ag.data$min, mean, na.rm=T),
                            mean.xz = tapply(ag.data$xz, ag.data$min, mean, na.rm=T),
                            mean.xyz = tapply(ag.data$xyz, ag.data$min, mean, na.rm=T))
